...
public class Main {
    ...
    public static boolean loadFont(String file, int size) {
        ...
        byte[] data;
        try (java.io.InputStream stream = Main.class.getResourceAsStream(file)) {
    ...
    public static void main(String[] args) {
        ...
        MP3Player audio = new MP3Player(new File("src\\" + musicFile));
        ...
        try (AudioInputStream audioInputStream =
                     AudioSystem.getAudioInputStream(
                             new BufferedInputStream(
                                     Objects.requireNonNull(Main.class.getResourceAsStream(musicFile))))) {
